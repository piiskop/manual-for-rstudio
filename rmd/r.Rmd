...
The figure \@ref(fig:ruler-uncertainties-with-accuracy) on the page `r render_pageref(reference="fig:ruler-uncertainties-with-accuracy")` shows how to specify the accuracy of the numbers on axis[@number].
