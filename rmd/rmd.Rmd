...
As for numeric referencing, the identifier is not textual, so we can use a short version for referencing whereas the identifier is the one in the BIB-file:
