...
\chemfig{
    ...
    O-[:-30]
    H
} `r render_with_emojis(text = "((ref:pubchem-copper))")`.
(\#eq:copper-glycerate)
\end{align}
...
Vesi ja hüdroksübenseen (fenool `r render_with_emojis(text = "((ref:haynes-2014-crc), p. 3-446)")`, $\chemfig{*6(-=-=(-OH)-=)}\qquad$ `r render_with_emojis(text = "((ref:haynes-2014-crc), p. 3-447)")`, tsükloalkeen) omavahel ei lahustu, sest hüdrofoobseid süsinikke on võrdlemisi palju.
